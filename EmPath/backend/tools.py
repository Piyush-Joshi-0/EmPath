...
from config import TELEGRAM_BOT_TOKEN, EMERGENCY_CHAT_ID


import requests
from config import EMERGENCY_CONTACT, TELEGRAM_BOT_TOKEN, EMERGENCY_CHAT_ID
...
def call_emergency():
    send_telegram_alert(
        "<b>🚨🚨 EMERGENCY ALERT 🚨🚨</b>\n"
        "━━━━━━━━━━━━━━━━━━━━━━━\n"
        "🆘 <b>Possible suicidal thoughts detected!</b>\n\n"
        f"📞 <b>Contact:</b> {EMERGENCY_CONTACT}\n"
        "⚠️ Immediate action required.\n"
        "━━━━━━━━━━━━━━━━━━━━━━━\n"
        "💬 <i>Stay calm, reach out, and ensure safety first.</i>\n"
        "━━━━━━━━━━━━━━━━━━━━━━━"
    )
